        ...
        <div className="col-12" style={{ position: "relative" }}>
          ...
          <div className="purpule_con">
            <div className="img-con-one">
              <img src="/images/newI.jpg" alt="image" />
            </div>
          </div>
        </div>
      ...
      <div className="my_info grid lg:grid-cols-4 grid-cols-1  mt-20">
        <div className="col-span-3">
          <h4 className=" preahvihear-regular my-3">
            I am the Motion Graphic Designer you’ve been looking for, ready to
            bring your vision to life with captivating designs and animations.
          </h4>
          <p className=" preahvihear-regular my-3">
            ...
            effectively and resonate with audiences. Passionate about blending
            design, storytelling, and technology to create compelling visual
            content. Experienced in working across industries, from branding to
            advertising, with a keen eye for aesthetics and strategic
            creativity. Adept at using industry-leading software to produce
            high-quality visuals that captivate audiences and drive engagement.
          </p>
        </div>
